			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center"><br>
				...
				<form method="POST">
					<div class="form-group">
						...
						<input type="text" name="cEmail" class="form-control" autocomplete="off">
					</div>
					<div class="form-group">
...
<?php
	...
	if (isset($_POST['btnLogin'])) {
		...
		$run = mysqli_query($con, "select * from clients where clientEmail = '$cEmail' and password = '$pass'");
		$row = mysqli_num_rows($run);
		if ($row >= 1) {
			$_SESSION['clientId'] = $cEmail;
